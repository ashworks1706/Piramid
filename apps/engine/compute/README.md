...
Distance and similarity kernels with CPU and GPU strategy dispatch, plus the quantization
...
batch methods take a contiguous row-major slab and a caller-owned `out`, because
